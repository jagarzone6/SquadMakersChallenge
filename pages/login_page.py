...
class LoginPage(BasePage):
    __username_field: Locator = Locator(By.ID, 'user-name')
    __password_field: Locator = Locator(By.ID, 'password')
    __login_button: Locator = Locator(By.ID, 'login-button')
    ...
    def wait_for_login_page_visible(self):
        self._wait_for_element_visible(LoginPage.__username_field, 5)
